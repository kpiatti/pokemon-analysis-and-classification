# format-pokemon-csv
# Formats of the pokemon.csv file so that it can be loaded into MySQL
# Updated 6/29/2021 DVS
...
with open("Data\\pokemon-filtered.csv", "wt") as pokemon_file_filtered:
